...
class FastSCNNV2(nn.Layer):
    ...
    def __init__(self,
        ...
        self.em_classifier = Classifier(128, 4)
    ...
    def forward(self, x):
        ...
        x0 = self.feature_fusion(higher_res_features, x)
        x1 = self.feature_fusion(higher_res_features, x)

        seg_logit = self.classifier(x0)
        emb_logit = self.em_classifier(x1)
