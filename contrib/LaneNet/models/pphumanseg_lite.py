...
__all__ = ['PPHumanSegLiteV2']


@manager.MODELS.add_component
class PPHumanSegLiteV2(nn.Layer):
    ...
    def __init__(self, num_classes, pretrained=None, align_corners=False):
        ...
        self.depthwise_separable3 = _SeparableConvBNReLU(64, 4, 3, stride=1)
    ...
    def forward(self, x):
        ...
        seg_logit = self.depthwise_separable2(x)
        emb_logit = self.depthwise_separable3(x)

        logit_list = [seg_logit, emb_logit]
